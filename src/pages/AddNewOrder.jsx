...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside
        className={`
          fixed md:static inset-y-0 left-0 z-40 w-64 bg-blue-700 text-white p-6 flex-col gap-6
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button 
                ...
                className="px-6 py-3 bg-blue-700 hover:bg-blue-900 text-white rounded-lg font-medium shadow-sm transition-colors"
              >
                Add Order
              </button>
            </div>
